...
import os
import source_logic.export_uncategorized_tx as auto_category_logic
import source_logic.load_manually_categorized_tx as manual_category_logic
...
def export_to_file(include_manually_categorized=True):
    ...
    final_list_filepath = os.path.join(utils.get_single_source_folder_path(), filename)
